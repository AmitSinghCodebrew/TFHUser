...
class MediaPreviewVC: BaseVC {
    ...
    var item: (images: [MediaObj]?, index: Int)?
...
extension MediaPreviewVC {
    ...
    func collectionSetup() {
        dataSource = CollectionDataSource(item?.images, ImagePreviewCell.identfier, collectionView, CGSize(width: ScreenSize.SCREEN_WIDTH, height: ScreenSize.SCREEN_HEIGHT) , UIEdgeInsets.init(top: 0, left: 0, bottom: 0, right: 0), 0, 0, .horizontal)
