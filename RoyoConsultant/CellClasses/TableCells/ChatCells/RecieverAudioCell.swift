...
class RecieverAudioCell: BaseChatCell {
    ...
    override func setupData() {
        ...
        activityInndicator.transform = CGAffineTransform.init(scaleX: 0.75, y: 0.75)
        activityInndicator.isHidden = !(/obj?.audioInfo?.isBuffering)
        /obj?.audioInfo?.isBuffering ? activityInndicator.startAnimating() : activityInndicator.stopAnimating()
    }
